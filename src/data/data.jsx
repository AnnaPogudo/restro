...
export const quickLinks = [
    { nameKey: 'footer.quickLinks.home', href: '#' },
    { nameKey: 'footer.quickLinks.aboutUs', href: '#about' },
    { nameKey: 'footer.quickLinks.menu', href: '#dishes' },
    { nameKey: 'footer.quickLinks.gallery', href: '#dishes' },
    { nameKey: 'footer.quickLinks.bookTable', href: '#booking-process' },
];

export const sitemapLinks = [
    { nameKey: 'footer.sitemap.policy', href: '#' },
    { nameKey: 'footer.sitemap.terms', href: '#' },
];
