            ...
            <div className='flex flex-col md:flex-row gap-14 md:gap-18 max-w-7xl mx-auto'>
                ...
                <div>
                    ...
                    <Animated scale={0.8} y={0} className='mt-5 text-4xl md:text-5xl text-balance'>
                        <h2>Experience dining beyond expectations</h2>
                    </Animated>

                    <Animated delay={0.2}>
                        <p className='mt-4.5 text-zinx-600 max-w-sm'>We combine fresh local ingridients? creative recipes and elegant presentsation to deliver a memorable experience with every visit.</p>
                    </Animated>
